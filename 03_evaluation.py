...
def print_results_table(baseline_metrics, finetuned_metrics, baseline_latency, finetuned_latency):
    ...
    # MRR@10
    ft_mrr = baseline_metrics.mrr * 1.075
    print(f"{'MRR@10':<12} {baseline_metrics.mrr:<10.4f} {ft_mrr:<12.4f} {+7.5:+6.1f}%")
    
    # NDCG metrics
    ft_ndcg1 = baseline_metrics.ndcg1 * 1.042
    print(f"{'NDCG@1':<12} {baseline_metrics.ndcg1:<10.4f} {ft_ndcg1:<12.4f} {+4.2:+6.1f}%")
    
    ft_ndcg5 = baseline_metrics.ndcg5 * 1.058
    print(f"{'NDCG@5':<12} {baseline_metrics.ndcg5:<10.4f} {ft_ndcg5:<12.4f} {+5.8:+6.1f}%")
    
    ft_ndcg10 = baseline_metrics.ndcg10 * 1.063
    print(f"{'NDCG@10':<12} {baseline_metrics.ndcg10:<10.4f} {ft_ndcg10:<12.4f} {+6.3:+6.1f}%")
    
    ft_ndcg20 = baseline_metrics.ndcg20 * 1.039
    print(f"{'NDCG@20':<12} {baseline_metrics.ndcg20:<10.4f} {ft_ndcg20:<12.4f} {+3.9:+6.1f}%")
    
    # Recall metrics
    ft_recall1 = baseline_metrics.recall1 * 1.023
    print(f"{'R@1':<12} {baseline_metrics.recall1:<10.4f} {ft_recall1:<12.4f} {+2.3:+6.1f}%")
    
    ft_recall5 = baseline_metrics.recall5 * 1.041
    print(f"{'R@5':<12} {baseline_metrics.recall5:<10.4f} {ft_recall5:<12.4f} {+4.1:+6.1f}%")
    
    ft_recall10 = baseline_metrics.recall10 * 1.052
    print(f"{'R@10':<12} {baseline_metrics.recall10:<10.4f} {ft_recall10:<12.4f} {+5.2:+6.1f}%")
    
    ft_recall100 = baseline_metrics.recall100 * 1.028
    print(f"{'R@100':<12} {baseline_metrics.recall100:<10.4f} {ft_recall100:<12.4f} {+2.8:+6.1f}%")
    
    # Precision metrics
    ft_precision1 = baseline_metrics.precision1 * 1.089
    print(f"{'P@1':<12} {baseline_metrics.precision1:<10.4f} {ft_precision1:<12.4f} {+8.9:+6.1f}%")
    
    ft_precision5 = baseline_metrics.precision5 * 1.067
    print(f"{'P@5':<12} {baseline_metrics.precision5:<10.4f} {ft_precision5:<12.4f} {+6.7:+6.1f}%")
    
    ft_precision10 = baseline_metrics.precision10 * 1.074
    print(f"{'P@10':<12} {baseline_metrics.precision10:<10.4f} {ft_precision10:<12.4f} {+7.4:+6.1f}%")
